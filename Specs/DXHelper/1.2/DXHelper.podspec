#
#  Be sure to run `pod spec lint DXHelper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/doorxp/DXHelper.git", :tag => "1.2" }
  ...
  s.source_files  = "Classes", "DXHelper/**/*.{h,m}"
  s.exclude_files = "Classes/Exclude"

  s.public_header_files = "DXHelper/**/*.h"
